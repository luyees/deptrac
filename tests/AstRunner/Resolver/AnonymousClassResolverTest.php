...
class AnonymousClassResolverTest extends TestCase
{
    public function testPropertyDependencyResolving(): void
    {
        ...
        static::assertSame($filePath, $dependencies[0]->getFileAppearance()->getFilenpath());
        static::assertSame(19, $dependencies[0]->getFileAppearance()->getLine());
        ...
        static::assertSame($filePath, $dependencies[1]->getFileAppearance()->getFilenpath());
        static::assertSame(19, $dependencies[1]->getFileAppearance()->getLine());
