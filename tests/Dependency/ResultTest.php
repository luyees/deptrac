...
class ResultTest extends TestCase
{
    public function testAddDependency(): void
    {
        ...
        $dependencyResult->addDependency($dep1 = new Dependency('A', 'B', new FileAppearance(new AstFileReference('a.php'), 12)));
        $dependencyResult->addDependency($dep2 = new Dependency('B', 'C', new FileAppearance(new AstFileReference('b.php'), 12)));
        $dependencyResult->addDependency($dep3 = new Dependency('A', 'C', new FileAppearance(new AstFileReference('a.php'), 12)));
    ...
    public function testGetDependenciesAndInheritDependencies(): void
    {
        $dependencyResult = new Result();
        $dependencyResult->addDependency($dep1 = new Dependency('A', 'B', new FileAppearance(new AstFileReference('a.php'), 12)));
        $dependencyResult->addInheritDependency($dep2 = new InheritDependency('A', 'B', $dep1, AstInherit::newExtends('B', new FileAppearance(new AstFileReference('a.php'), 12))));
